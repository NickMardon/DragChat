...
export default function Description(props) {
    ...
    return (
        <div className="jumbotron">
            ...
            <h4>Create an account or sign in to get started!  Users can join and create halls to host multiple rooms of video conferences.  Use our intuitive drag and drop interface to change rooms within your hall and utilize our global chat to communicate with other users.</h4>
